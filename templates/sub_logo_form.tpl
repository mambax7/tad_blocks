    ...
    <form action="blocks.php" id="myForm" method="post" role="form" class="form-horizontal">
        <div class="alert alert-success">
            <div class="form-group row mb-3">
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="size"><{$smarty.const._MD_TAD_BLOCKS_LOGO_TEXT_SIZE}></label>
                <div class="col-sm-2">
                ...
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="border_size"><{$smarty.const._MD_TAD_BLOCKS_LOGO_BORDER_SIZE}></label>
                <div class="col-sm-2">
                ...
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="shadow_size"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_SIZE}></label>
                <div class="col-sm-2">
            ...
            <div class="form-group row mb-3">
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="font_color"><{$smarty.const._MD_TAD_BLOCKS_LOGO_TEXT_COLOR}></label>
                <div class="col-sm-2">
                    <div class="input-group">
                        <input type="text" name="TDC[color]" class="form-control color-picker" value="<{$color|default:''}>" id="font_color" data-hex="true">
                    </div>
                </div>
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="border_color"><{$smarty.const._MD_TAD_BLOCKS_LOGO_BORDER_COLOR}></label>
                <div class="col-sm-2">
                    <div class="input-group">
                ...
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="shadow_color"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_COLOR}></label>
                <div class="col-sm-2">
                    <div class="input-group">
            ...
            <div class="form-group row mb-3">
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="font_file_sn"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SELECT_FONT}></label>
                <div class="col-sm-2">
                ...
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="shadow_x"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_X}></label>
                <div class="col-sm-2">
                    <input type="number" name="TDC[shadow_x]" class="col-sm-10 form-control" value="<{$shadow_x|default:''}>" id="shadow_x">
                </div>
                <label class="col-sm-2 control-label col-form-label text-sm-right text-sm-end" for="shadow_y"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_Y}></label>
                <div class="col-sm-2">
